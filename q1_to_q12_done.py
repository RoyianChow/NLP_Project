...
new_comments = [
    "Hey Katy Perry! I love you",
    "Free money. Click here for your prize. https://www.spam.com.",
    "thank you",
    "Get rich quick with this amazing opportunity!",
    "I can't believe how great this youtube video is!",
    "Amazing product at an unbeatable price!"
]
new_comments_transformed = tfidf.transform(vectorizer.transform(new_comments))
new_comments_pred = model.predict(new_comments_transformed)

# Print the predictions for the new comments
for i in range(len(new_comments)):
    print(f"Comment: {new_comments[i]}\nPrediction: {new_comments_pred[i]}")
